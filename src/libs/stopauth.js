...
//       // Set custom cookie with token value from login response

//       cookies.set('custom-auth-token', user.token, {
//         httpOnly: true,
...
//           if (res.status === 200 && data) {
//             // Ensure to remove sensitive information from the user object
//             const user = {
//               id: data.id,
//               email: data.email,
//               role: data.role,
